...
struct { char name[60];
         ...
         struct date dob;
         struct date deposit;
         struct date withdraw; }add,upd,check,rem,transaction;
...
system("cls");
printf("Loading");
for(i=0;i<6;i++){fordelay(100000000);printf(".");}
goto account_no;
}
}
...
scanf("%s",add.name);
printf("\nEnter the date of birth(dd/mm/yyyy-format):");
...
{
printf("\n%d\t%10s\t\t\t%10s\t\t%.0lf",add.acc_no,add.name,add.address,add.phone);test++;
}
fclose(view);
if (test==0)
{ system("cls");
...
{ test=1;
printf("\nWhich information do you want to change?\n1.Address\n2.Phone\n\nEnteryour choice(1 for address and 2 for phone):");scanf("%d",&choice);
system("cls");
...
{
printf("\a\a\a\n\nYOU CANNOT DEPOSIT OR WITHDRAW CASH IN FIXEDACCOUNTS!!!!!");
fordelay(1000000000);
system("cls");
menu();
}
printf("\n\nDo you want to\n1.Deposit\n2.Withdraw?\n\nEnter your choice(1 fordeposit and 2 for withdraw):");
scanf("%d",&choice);
if (choice==1)
{
...
printf("\n\nYou will get Rs.%.2f as interest on %d of everymonth",intrst,add.deposit.day);
}
...
printf("\n\n\t\t1.Create new account\n\t\t2.Update information of existingaccount\n\t\t3.For transactions\n\t\t4.Check the details of existing account\n\t\t5.Removingexisting account\n\t\t6.View customer's list\n\t\t7.Exit\n\n\n\n\n\t\t Enter your choice:");
scanf("%d",&choice);
system("cls");
switch(choice)
{
...
system("color 3f");
char
*usernames[6]={"abhinav01","arihanth03","Ragul45","MLN26","Niranjan31","Harihara"};
char
*passwords[6]={"Abhi1501$","Ari01*","ragul45^","MLN2003&","nira31@","Hari$"};
...
if(c!=1)
{ help:
printf("\n\nInvalid Username or password!!\a\a\a");
login_try:
